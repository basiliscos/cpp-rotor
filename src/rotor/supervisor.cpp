...
supervisor_t::supervisor_t(supervisor_t *sup)
    : actor_base_t(sup ? *sup : *this) {}
...
void supervisor_t::do_start() noexcept {
  send<payload::start_supervisor_t>(address);
}
...
void supervisor_t::unsubscribe_actor(address_ptr_t addr,
                                     handler_ptr_t &handler_ptr) noexcept {
  unsubscription_queue.emplace_back(subscription_request_t{handler_ptr, addr});
}

void supervisor_t::unsubscribe_actor(const actor_ptr_t &actor,
                                     bool remove_actor) noexcept {
...
void supervisor_t::on_initialize(
    message_t<payload::initialize_actor_t> &msg) noexcept {
...
void supervisor_t::on_shutdown_confirm(
