...
const std::type_index address_maker_plugin_t::class_identity = typeid(address_maker_plugin_t);

const std::type_index &address_maker_plugin_t::identity() const noexcept { return class_identity; }
