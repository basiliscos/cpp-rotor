...
struct actor_test_t : public actor_base_t {
    ...
    //virtual actor_behavior_t *create_behavior() noexcept override { return new test_behaviour(*this); }

    state_t &get_state() noexcept { return state; }
    actor_config_t::plugins_t& get_inactive_plugins() noexcept { return  inactive_plugins;}
    actor_config_t::plugins_t& get_active_plugins() noexcept { return  active_plugins;}
