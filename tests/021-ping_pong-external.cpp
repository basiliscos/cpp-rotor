...
struct pinger_t : public r::actor_base_t {
    ...
    pinger_t(r::supervisor_t &sup) : r::actor_base_t{sup} { ping_sent = pong_received = 0; }
...
struct ponger_t : public r::actor_base_t {
    ...
    ponger_t(r::supervisor_t &sup) : r::actor_base_t{sup} { ping_received = pong_sent = 0; }
...
TEST_CASE("pinger & ponger on different supervisors, manually controlled", "[supervisor]") {
    ...
    auto sup1 = system_context.create_supervisor<rt::supervisor_test_t>(nullptr, r::pt::milliseconds{500}, locality1);
    auto sup2 = sup1->create_actor<rt::supervisor_test_t>(r::pt::milliseconds{500}, locality2);
