...
int main(int argc, char **argv) {
    try {
        ...
        auto sup_ev = sys_ctx_ev->create_supervisor<rotor::ev::supervisor_ev_t>(timeout, conf_ev);
        auto sup_asio = sys_ctx_asio->create_supervisor<rotor::asio::supervisor_asio_t>(timeout, conf_asio);
